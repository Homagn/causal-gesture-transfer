...
class gazebo_client(object):
    def __init__(self, host = 'localhost', port = 60000): #10.24.250.119
...
if __name__ == '__main__':
    ...
    cv2.imwrite('data/images/1_front1.png', observations[3]['rgb']) 
    cv2.imwrite('data/images/1_front2.png', observations[4]['rgb']) 

    cv2.imwrite('data/images/2_side1.png', observations[3]['rgb_side']) 
    cv2.imwrite('data/images/2_side2.png', observations[4]['rgb_side']) 
